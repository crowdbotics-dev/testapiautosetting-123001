...
## Project Structure
    ...
    ├── testapiautosetting_123001  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123001`
...
2. Clone this repo and `cd testapiautosetting_123001`
